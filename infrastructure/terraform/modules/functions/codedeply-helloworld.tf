...
resource "azapi_resource" "helloworld_function_code_deploy" {
  ...
  body = jsonencode({
    "properties" : {
      "packageUri" : "https://github.com/Azure/ai-hub/raw/5056c8e6def59cdf486396e01c34e51afa5e5ab7/infrastructure/terraform/modules/functions/rag.zip",
      "appOffline" : true
    }
  })
}
